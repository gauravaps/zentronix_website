...
const TaxiDispatch = () => {
 const [currentImage, setCurrentImage] = useState("/images/taxi1.jpg");
    ...
    <div className="grocery-app">
      ...
      <section className="grocery-hero">
        ...
        <div className="grocery-hero-right">
          <h1>
            Taxi Dispatch <span>Development Services</span>
          </h1>
  <p>
  At <b>Zentronix Infotech</b>, we build 
  <b> secure, scalable, and user-friendly taxi dispatch applications</b> that 
  help taxi businesses, fleet owners, and startups streamline their ride-hailing 
  operations. Our goal is to simplify booking, improve customer experience, 
  and ensure seamless communication between drivers and passengers. 
  <br /><br />
  With a strong focus on <b>real-time tracking, automation, and innovation</b>, 
  our solutions include features like ride booking & scheduling, GPS-based 
  navigation, fare estimation, driver & passenger apps, automated dispatch, 
  in-app payments, ratings & reviews, and fleet management dashboards. 
  <b> Zentronix Infotech</b> enables taxi service providers to boost 
  efficiency, reduce operational costs, and scale effortlessly in today’s 
  fast-growing ride-hailing market.
</p>
