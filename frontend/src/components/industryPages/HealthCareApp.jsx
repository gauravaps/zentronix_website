...
const HealthCareApp = () => {
 const [currentImage, setCurrentImage] = useState("/images/health1.jpg");
    ...
    <div className="grocery-app">
      ...
      <section className="grocery-hero">
        ...
        <div className="grocery-hero-right">
          <h1>
            Health Care App <span>Development Services</span>
          </h1>
    <p>
  ...
  monitoring, and AI-powered diagnostics. 
  <b>Zentronix Infotech</b> enables healthcare organizations to provide 
  better patient care, increase efficiency, and scale effortlessly in today’s 
  rapidly evolving digital health ecosystem.
</p>
